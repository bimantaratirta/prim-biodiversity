...
export default function StackedHorizontalBar({ data }: StackedHorizontalBarProps) {
  return (
      ...
      <BarChart data={data} layout="vertical" margin={{ left: 20, right: 20 }}>
        ...
        <Tooltip
          ...
          formatter={(value: number, name: string) => [
            ...
            name === "offsite" ? "Di luar Wilayah Kerja" : "Beririsan dengan Wilayah Kerja",
          ]}
        />
        <Legend
          formatter={(value: string) =>
            value === "offsite" ? "Di luar Wilayah Kerja (Offsite)" : "Beririsan dengan Wilayah Kerja (Overlap)"
          }
        />
