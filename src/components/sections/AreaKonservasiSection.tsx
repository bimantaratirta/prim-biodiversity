  ...
  return (
    <SectionWrapper id="area-konservasi" background="gray">
      ...
      <p className="section-subtitle">
        Total area yang dikelola untuk pelestarian keanekaragaman hayati
      </p>

      <div className="mt-6">
        <NarrativeBlock>
          <p>
            Area konservasi mencakup wilayah yang dikelola secara khusus untuk
            pelestarian biodiversitas, baik di dalam maupun di luar wilayah kerja
            operasi. Pada tahun 2024, Pertamina mengelola total{" "}
            <strong>{formatNumber(total2024, 2)} hektar</strong> area konservasi
      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-2">
        <div className="card">
          <h3 className="mb-4 text-sm font-semibold text-gray-700">
            Total Area per Sub-Holding ({year})
          </h3>
          {barData.length > 0 ? (
            <HorizontalBar data={barData} />
          ) : (
            <p className="py-8 text-center text-sm text-gray-400">
              Tidak ada data area untuk tahun {year}
            </p>
          )}
        </div>
          ...
          {year === 2024 ? (
            ...
            <div className="flex items-center justify-center py-8">
              <p className="text-sm italic text-gray-400">
                Data offsite/overlap tidak tersedia di tahun 2023
              </p>
            </div>
          )}
        </div>
      ...
      <div className="mt-8">
        <NarrativeBlock variant="insight">
          <p>
            <strong>SH Upstream</strong> mendominasi luasan area konservasi
            (90,8% dari total 2024), didorong oleh area operasi Pertamina Hulu
            Rokan yang sangat luas. Peningkatan drastis dari 2023 ke 2024
            mencerminkan perbaikan pendataan dan pelaporan, bukan hanya
